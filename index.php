			...
			<div class="panel panel-info" style="">
				...
				<div class="panel-body">
					 ...
					 <form class="form-horizontal" method="POST" id="login_form">
									...
									<button type="submit" class="btn btn-info">Logar</button> <br>
									</div>

									<div class="col-sm-12">
										<div class="alert alert-success" id="correct"> Logado com sucesso!</div>
										<div class="alert alert-danger" id="error"> Erro ao fazer login </div>
									</div>
									</div>
