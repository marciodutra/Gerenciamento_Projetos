...
<br>
   ...
   <?php  if($row2['user_type'] == '2'){?><option value="1">Administrador</option> <?php } ?>
    <?php  if($row2['user_type'] == '1'){?><option value="2">Contratante</option><?php } ?>
   </select>
    </div>
    </div>
<br>
<br>
   ...
   <?php  if($row2['status'] == '2'){?><option value="1">Ativo</option> <?php } ?>
    <?php  if($row2['status'] == '1'){?><option value="2">Inativo</option><?php } ?>
   </select>
    </div>
    </div>
<br>
