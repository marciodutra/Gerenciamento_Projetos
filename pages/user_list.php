...
<div class="col-lg-7">
	<div class="panel panel-default">
        ...
        <?php if($_GET['io'] == '2'){ $btn_class = 'class="btn btn-md btn-success"';} else{ $btn_class = 'class="btn btn-md btn-default"';} ?>
          <a href="index.php?page=user_list&io=1" <?php echo $btn_class1 ?> > Ativo</a>
          <a href="index.php?page=user_list&io=2" <?php echo $btn_class ?> > Inativo</a>
    ...
    <thead>
      <tr id="heads">
        ...
        <th class="col-md-2 text-center">Tipo de usuário</th>
    ...
    ?>
      <tr>
        ...
        <td style="text-transform:capitalize" class="text-center"><?php  if($row['user_type'] == '1'){ echo 'Administrador';}else{ echo 'Staff';} ?></td>
        <td style="text-transform:capitalize" class="text-center"><center><a onclick="edit_user('<?php echo $id2 ?>')" ><i class="fa fa-edit"></i> Editar</a></center></td>
       </tr>
...
<div class="col-md-5">
  ...
  <div id="user">
 <center><h4>Novo usuário</h4></center>

  <hr style="border-bottom:1px solid grey"></hr>
  <div class="alert alert-success" id="msg"><i class="fa fa-check"></i> Dados adicionados com sucesso. </div>
    <form id="user_form" method="POST">
    <div class="form-group">
    <div class="col-sm-4 text-right"><label for="emp">Funcionário:</label></div>
    <div class="col-sm-8">
    <select name="eid" id="emp" class="form-control chosen-select" data-placeholder="Selecione o Funcionário">
    <option value=""></option>
      <?php
    include '../includes/db.php';
...
<br>
    <div class="form-group">
    <div class="col-sm-4 text-right"><label for="pass">Senha:</label></div>
    <div class="col-sm-8">
...
<br>
    <div class="form-group">
    <div class="col-sm-4 text-right"><label for="u_type">Tipo de usuário:</label></div>
    <div class="col-sm-8">
    ...
    <div class="form-horizontal">
      <div class="form-group">
        <div class="col-sm-12">
          ...
          <button class="col-sm-2 btn btn-info btn-sm" id="save_pos">Salvar</button>
          <div class="col-sm-2"></div> 
          <a class="col-sm-2 btn btn-info btn-sm" onclick="window.location.reload()">Cancelar</a> 
          </center>
        </div>
      </div>
    </div>
