...
<div class="panel panel-default">
	...
	<div class="col-md-4">
		<div class="form-group">
			<div class="col-sm-2"><label for="">Funcionário:</label></div>
			<div class="col-sm-10">
			<select name="fid" id="" class="form-control chosen-select" data-placeholder="Selecione o funcionário">
			<option></option>
				<?php
		...
		<div class="form-group">
			<div class="col-sm-2"><label for="">Membro:</label></div>
			<div class="col-sm-10">
			<select name="mid" id="mid" class="form-control chosen-select" data-placeholder="Selecione funcionário">
			<option></option>
				<?php
	...
	<div class="col-md-6">
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="col-sm-2 text-center">Nome</th>
	...
	<center>
		<button class="btn-sm btn-info">Salvar</button>
		<button type="button" onclick="window.location.reload()" class="btn-sm btn-info">Cancelar</button>
	</center>
	</div>
	</div>
	</form>
						...
						jQuery("#teams").submit(function(e){
								...
								$.ajax({
									...
									success: function(html){
										$('#rcode').html('<center><div class="alert alert-success"><h4 id="msg"><i class="fa fa-fw fa-check"></i>  Dados adicionados com sucesso.</h4><div></center>');
										var delay = 2000;
...
<script type="text/javascript">
    var config = {
      ...
      '.chosen-select-no-results': {no_results_text:'Ops, nada encontrado!'},
