...
<div class="panel-body">
	...
	<center><a  href="#change_pic" data-toggle="modal">Alterar imagem</a></center>
	</div>
	<br>
	<br>
	<br>
	<div class="col-md-6">
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Nome:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo $row['name'] ?></label></div>
	</div>
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Aniversário:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo date("F d, Y",strtotime($row['bday'])) ?></label></div>
	</div>
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Idade:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo $age ?></label></div>
	</div>
	
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Endereço:</label></div>
	...
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Posição:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php echo $row['position'] ?></label></div>
	</div>

	<?php if(!isset($_GET['dattyp'])){ ?>
		<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Status do perfil:</label></div>
...
<?php if(isset($_GET['dattyp'])){ ?>
	<a href="index.php?page=employee&io=1" class="btn btn-sm btn-info"> FEITO </a>
	<a href="cancel_emp.php?id=<?php echo $id ?>" class="btn btn-sm btn-info"> Cancelar </a>
	<?php }else{ ?>
	<a href="#update_emp" data-toggle="modal" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Editar </a>
	<a href="index.php?page=employee&io=1" class="btn btn-sm btn-info"><i class="fa fa-"></i> Voltar </a>
	<?php } ?>
</div>
</div>
</div>
