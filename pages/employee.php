...
<div class="col-lg-10">
	<div class="panel panel-default">
        ...
        <?php if($_GET['io'] == '2'){ $btn_class = 'class="btn btn-md btn-success"';} else{ $btn_class = 'class="btn btn-md btn-default"';} ?>
          <a href="index.php?page=employee&io=1" <?php echo $btn_class1 ?> > Ativo</a>
          <a href="index.php?page=employee&io=2" <?php echo $btn_class ?> > Inativo</a>
    ...
    ?>
      <tr>
        ...
        <td style="text-transform:capitalize" class="text-center"><center><a href="index.php?page=employee_profile&id=<?php echo $id ?>" ><i class="fa fa-eye"></i> Perfil</a></center></td>
       </tr>
...
<div class="col-md-2">
	...
	<a class="col-sm-12 btn btn-md btn-info"  href="#new_employee" data-toggle="modal"><center><i class="fa fa-plus"></i>Novo empregado</center></a>
</div>
<div id="retCode1"></div>
