...
<div class="col-md-12">
	<h4>Lista de Divisões do Projeto</h4>
...
<div class="col-lg-8">
    ...
    <thead>
      <tr id="heads">
        ...
        <th class="col-md-2 text-center">Divisões</th>
        <th class="col-md-1 text-center">Tipo de projeto</th>
        <th class="col-md-1 text-center"></th>
      </tr>
    </thead>
    <tbody>
    ...
    ?>
      <tr>
        ...
        if($row['project_type'] == '1'){
        	echo 'Construção de casas';
        } elseif($row['project_type'] == '3'){
        	echo 'Rodovias';
        }elseif($row['project_type'] == '0'){
        	echo 'Todos';
        }elseif($row['project_type'] == '4'){
        	echo 'Grande arquibancada';
        }elseif($row['project_type'] == '5'){
        	echo 'Área Coberta';
        }
         ?><input type="hidden" id="typ<?php echo $id ?>" value="<?php echo $row['project_type'] ?>"></td>
        <td style="text-transform:capitalize" class="text-center"><center><a onclick="update_div(<?php echo $id ?>)"><i class="fa fa-pencil"></i> editar</a></center></td>
       </tr>
...
<div class="col-md-4">
	...
	<a class="col-sm-12 btn btn-md btn-info" id="add_div" onclick="add_form()"><center><i class="fa fa-plus"></i> Adicionar</center></a>
	<br>
<div id="add_form">
	<h4 id="frm-title">Nova Divisão</h4>
	<hr style="border-bottom:1px solid grey"></hr>

	<form method="POST" id="pos_form">
		<div class="form-horizontal">
			<div class="form-group">
			<div class="col-sm-4"><label class="control-label" for="pos">Divisão:</label></div>
				<div class="col-sm-7">
			...
			<div class="col-sm-4"><label class="control-label" for="pos">Tipo de projeto:</label></div>
				<div class="col-sm-7">
					...
					<option value="1">Construção de casas</option>
		...
		<div class="form-horizontal">
			<div class="form-group">
				<div class="col-sm-12">
					<center>
					<button class="col-sm-4 btn btn-info btn-sm" id="save_pos">Salvar</button>
					<div class="col-sm-4"></div> 
					<a class="col-sm-4 btn btn-info btn-sm" onclick="can_pos()">Cancelar</a> 
					</center>
				</div>
			</div>
		</div>
