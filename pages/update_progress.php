...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Status do projeto:</label></div>
		<div class="col-sm-8 text-left"><label class="control-label"><?php  if($row['stats'] == '1'){ echo 'Em andamento';}elseif($row['stats'] == '2'){ echo 'Finalizado'; }elseif($row['stats'] == '3'){ echo 'Cancelado'; } ?></label></div>
	</div>
...
<br>
<center>
	<h4><b>-- Novo Progresso</b></h4>
</center>

	<form action="../forms/add_forms.php?action=progress" method="POST" enctype="multipart/form-data" >
	<div class="row">
		
			<div class="col-sm-4 text-right"><label for="" class="control-label">Divisão:</label></div>
			<div class="col-sm-8">
	...
	<div class="row">
		...
		<div class="col-sm-4 text-right"><label for="" class="control-label">Progresso:</label></div>
	...
	<br>
	<div class="row">
		<div class="col-sm-4 text-right"><label for="" class="control-label">Imagem:</label></div>
	...
	<div class="row">
		...
		<div class="col-sm-8 col-sm-offset-4">
			<button id="btn_save" class="btn btn-sm btn-info"><i class="fa fa-save"></i> Salvar</button>
			<button type="reset" class="btn btn-sm btn-info"><i class="fa fa-reset"></i> Cancelar</button>
		</div>
	</div>
	</form>
	</div>
	...
	<div class="col-md-8">
		...
		<div class="col-sm-12" id="progress2">
			<center><h5><b>-- Progresso do projeto --</b></h5></center>
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th class="col-sm-2 text-center">Divisão</th>
				<th class="text-center" style="width:1% !important">Progresso</th>
				<th class="col-sm-1 text-center">Data de atualização</th>
				<th class="col-sm-1 text-center">Ação</th>
			</tr>
		</thead>
		<tbody>
			<?php
			...
			while($row2 = mysqli_fetch_assoc($query)){
			 ...
			 <tr>
			 	...
			 	<td><center><a href="#progess<?php echo $row2['prog_id'] ?>" data-toggle="modal"><i class="fa fa-pencil"> </i> Editar</a></center></td>
			 </tr>
			 <?php include '../includes/update_modals.php' ?>
			<?php }}else{ ?>
			
					<tr>
						<td colspan='5'><center>Ainda não há dados.</center></td>
					</tr>
			<?php } ?>
		</tbody>
	</table>
