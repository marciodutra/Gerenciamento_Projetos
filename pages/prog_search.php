...
?>
	<div class="panel panel-deafault">
		<div class="panel panel-body">
			...
			<div class="col-sm-12 col-sm-offset-11"><a href="index.php?page=update_progress&id=<?php echo $id ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> ALTERAR</a></div>
	...
	<div class="panel panel-deafault">
		<div class="panel panel-body">
			<div class="col-sm-12">
				...
				<center><h4><b>Nenhum resultado ..</b></h4></center>
			</div>
