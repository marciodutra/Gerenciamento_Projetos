...
<div class="col-lg-8">
	<div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title"><strong>Posições.</strong></h3>
        </div> 
    ...
    <thead>
      <tr id="heads">
        <th class="col-md-2 text-center">Posições</th>
        <th class="col-md-2 text-center">Diária</th>
    ...
    ?>
      <tr>
        ...
        <td style="text-transform:capitalize" class="text-center"><center><a href="#pos<?php echo $id ?>" data-toggle="modal"><i class="fa fa-pencil"></i> editar</a></center></td>
       </tr>
...
<div class="col-md-4">
	...
	<a class="col-sm-12 btn btn-md btn-info" id="add_pos" onclick="add_form()"><center><i class="fa fa-plus"></i> Adicionar</center></a>
	<br>
<div id="add_form">
	<h4>Nova posição</h4>
	...
	<form method="POST" id="pos_form">
		<div class="form-horizontal">
			...
			<div class="col-sm-2"><label class="control-label" for="pos">Posição:</label></div>
				<div class="col-sm-7">
		...
		<div class="form-horizontal">
			<div class="form-group">
			<div class="col-sm-4"><label class="control-label" for="dr">Diária:</label></div>
				<div class="col-sm-5">
