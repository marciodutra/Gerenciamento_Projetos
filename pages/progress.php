...
<span class="input-group-addon"> <i class="fa fa-search " aria-hidden="true"></i></span>
  <input type="text" class="form-control input-md" id="search" onkeydown="search_query()" onkeyup="search_query()"   placeholder="Pesquisar.." />
 </div>
</div><br>
...
?>
	<div class="panel panel-deafault">
		<div class="panel panel-body">
			...
			<div class="col-sm-12 col-sm-offset-11"><a href="index.php?page=update_progress&id=<?php echo $id ?>" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Atualizar</a></div>
